...
class TestTransitionFilling:
    def test_transition_filling(self, driver_existing_credential):
        ...
        action = WebDriverWait(driver_existing_credential, 3).until(EC.visibility_of_element_located(Locators.action_layer))
...
class TestTransitionBread:
    def test_transition_bread(self, driver_existing_credential):
        ...
        WebDriverWait(driver_existing_credential, 3).until(EC.visibility_of_element_located(Locators.text_sauce))
